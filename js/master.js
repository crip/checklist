...
$.fn.toggleAria = function (attr, closed, open) {
  return this.each(function () {
    var self = $(this);
    if (self.attr(attr) == closed) self.attr(attr, open);
    else self.attr(attr, closed);
  });
};
...
// Hash link filter
checklist.filter("make_slug", function () {
  ...
  function ($scope) {
    ...
    var checkboxes = [
      {
        section: "General",
        section_description:
          "Usable by all intended users, despite disability, access device, or environmental conditions.",
        checkboxes: [
          {
            title:
              "Symbol/control must meet minimum size, space, and contrast requirements.",
            description:
              "Things to consider: Icon must be at least 16px to ensure minimum readability. \"Apple recommends a minimum target size of 44 pixels wide 44 pixels tall\" <a href='http://lukew.com/ff/entry.asp?1085' target='_blank'>(Touch Target Sizes)</a>.",
            done: false,
          },
          {
            title:
          ...
          },
          {
            ...
            description:
              '<a href="http://contrastchecker.com/" target="_blank">Contrast Checker</a>',
            done: false,
          },
          {
            title:
            ...
            description:
              'Things to consider: desktop (20-24 inches away from screen), tablet (18 inches away from screen) and mobile screen (16 inches away from screen)? <a href="http://sizecalc.com/" target="_blank">Size Calculator</a> and <a href="http://type-scale.com/" target="_blank">Type Scale</a>',
            done: false,
          },
          {
            title:
          ...
          },
          {
            ...
            description:
              'By having descriptive links, when screenreader users set their screen reader to only read out links, they’ll be able to understand what they’re for when the links get read out. Avoid having links with generic descriptions like "click me" or "read more". However if you must use generic descriptions, add a <code>title</code> attribute with a better description, or hide the description off screen using helper classes.',
          ...
          },
          {
            ...
            description:
              'Provide focus state on any focusable elements e.g. links, buttons. Anywhere hover state is declared, focus style should be declared as well, and at least have it matching the hover style if there isn’t specific focus style. Also, never set <a href="http://outlinenone.com/">outline: none</a> in your CSS.',
      ...
      },
      {
        ...
        section_description:
          "To use your templates, many customers will rely on ease of access features or devices such as screen readers and high contrast settings. As you develop templates, keep these accessibility guidelines in mind.",
        checkboxes: [
          {
    ...
    $scope.clearLocalStorage = function () {
      var confirmClear = confirm(
        "Are you sure you want to clear the progress?"
      );
      if (confirmClear) {
